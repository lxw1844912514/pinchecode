...
<div class="header100">
    ...
    <div class="tab">
        <a href="<?php echo create_addon_url('index');?>/type/1" class="<?php echo ($car); ?>"><i class="iconfont">&#xe618;</i>找车主</a>
        <a href="<?php echo create_addon_url('index');?>/type/2" class="<?php echo ($man); ?>"><i class="iconfont">&#xe615;</i>找乘客</a>
    </div>
...
<?php
    ...
    <div class="tools">
        ...
        <div class="sort">
            <a href="<?php echo create_addon_url('index');?>/go/0" class="<?php echo ($go1); ?>">发布时间</a>
            <a href="<?php echo create_addon_url('index');?>/go/2" class="<?php echo ($go2); ?>">出发时间</a>
        </div>
    </div>
            ...
            <li>
                <div class="h">
                    <a href="<?php echo create_addon_url('detail');?>/id/<?php echo $v['id'];?>"><em>
                        <?php
 if($v['types']==1){ echo '车找人'; }else{ echo '人找车'; } ?></em>  <?php echo date('Y-m-d H:i:s',$v['gotime'])?> &nbsp;&nbsp; 从<?php echo $v['from'];?>至<?php echo $v['to'];?></a>
                </div>
                <div class="b">
                    <span class="status"><span class='greenFont'><?php echo ($v['gotime']>time())?'正常':'已过期'; ?></span></span>
                    <a href="<?php echo create_addon_url('update');?>/id/<?php echo $v['id'];?>">编辑</a>
                    <a onclick="del(<?php echo $v['id'];?>)"  href="javascript:;">删除</a>
                </div>
            </li>
            <?php
 } ?>
    ...
    <!--<a href="<?php echo create_addon_url('config');?>/mpid/<?php echo get_mpid();?>" class="mlink">管理</a>-->
...
<div id="b-menu" class="animated fadeInUp">
    <a href="<?php echo create_addon_url('index');?>/mpid/<?php echo get_mpid()?>" style="width: 33%"><i class="iconfont">&#xe61b;</i>首页</a>
    <a href="<?php echo create_addon_url('add');?>/mpid/<?php echo get_mpid()?>" style="width: 34%" class="sel"><i class="iconfont">&#xe61a;</i>发布</a>
    <a href="<?php echo create_addon_url('user');?>/mpid/<?php echo get_mpid()?>" style="width: 33%"><i class="iconfont">&#xe61d;</i>我的</a>
</div>
